        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I am <span className="font-semibold text-primary">Banti Kushwaha</span>, 
              a passionate <span className="font-semibold">Full Stack Web Developer</span> 
              and current <span className="font-semibold">MCA student at SRM Institute of Science and Technology, Kattankulathur, Chennai</span>.  
              I have completed my <span className="font-semibold">BCA from Usha Martin University, Ranchi</span>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="https://www.linkedin.com/in/banti-kumar-534997265/"
                target="_blank"
                className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 shadow-lg hover:scale-105 transition-colors duration-300"
              >
                LinkedIn Profile
              </a>

              <a
                href="https://drive.google.com/file/d/10GECYPAVlFqoV7JJDZJJtw1Bl_oTRstD/view?usp=drivesdk"
                target="_blank"
                className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 shadow-lg hover:scale-105 transition-colors duration-300"
              >
                Download CV
